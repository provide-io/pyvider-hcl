...
from provide.testkit import temp_directory, test_files_structure, temp_config_file


@pytest.fixture
def hcl_temp_dir(temp_directory):
...
@pytest.fixture
def multi_file_hcl_structure(temp_directory):
...
@pytest.fixture
def hcl_config_file(temp_directory):
...
'''
    config_file = temp_directory / "config.hcl"
    config_file.write_text(content)
    return config_file


@pytest.fixture
def nested_object_hcl():
