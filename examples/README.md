...
1. **[02_schema_validation.py](02_schema_validation.py)** - Schema validation

   - Define CTY schemas
   - Validate HCL data
   - Handle validation errors

1. **[03_type_inference.py](03_type_inference.py)** - Automatic type inference

   - Let pyvider-hcl infer types
   - Understand inferred types
   - When to use inference vs schemas

1. **[04_terraform_variables.py](04_terraform_variables.py)** - Terraform variables

   - Create variable structures
   - Set defaults and descriptions
   - Handle sensitive variables

1. **[05_terraform_resources.py](05_terraform_resources.py)** - Terraform resources

   - Create resource structures
   - Define resource attributes
   - Type validation for resources

1. **[06_complex_structures.py](06_complex_structures.py)** - Complex nested structures

   - Parse nested objects
   - Handle lists of objects
   - Complex type definitions

1. **[07_error_handling.py](07_error_handling.py)** - Error handling

   - Catch parsing errors
   - Handle validation failures
   - Error context and debugging

1. **[08_multi_file_project.py](08_multi_file_project.py)** - Multi-file projects
