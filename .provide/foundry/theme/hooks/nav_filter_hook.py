...
def on_nav(nav: Navigation, config: MkDocsConfig, files: Files) -> Navigation:
    ...
    # Default hidden paths for terraform providers
    default_hidden = [
        "providers/provide-io/pyvider/latest/docs",
        "providers/provide-io/tofusoup/latest/docs",
    ]

    # Combine configured and default paths
    all_hidden_paths = hidden_paths if hidden_paths else default_hidden
