...
def generate_reference_pages() -> None:
    ...
    for parts, doc_path, source_path in _iter_module_docs(src_root):
        nav[parts] = str(doc_path.relative_to("reference"))
...
def _iter_module_docs(src_root: Path) -> Iterator[tuple[tuple[str, ...], Path, Path]]:
